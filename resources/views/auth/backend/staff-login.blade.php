                    ...
                    <div class="col-lg-5 col-md-8 d-flex flex-column align-items-center justify-content-center">
                        <div class="card mb-3">
                            ...
                            <div class="pt-4 pb-2 d-flex align-items-center">
                                ...
                                <h5 class="card-title text-center pb-0 fs-4" style="font-size:25px;">Staff Login</h5>
                            </div>

                                <form method="POST" action="{{ route('staff.login') }}" class="row g-3 needs-validation" novalidate>
                                    @csrf
                                    <div class="col-12">
